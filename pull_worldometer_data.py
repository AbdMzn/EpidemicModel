...
def pull_worldometer_data(country_name):
    try:
        ...
        folder_path = 'worldometer_data'
        if not os.path.exists(folder_path):
            os.makedirs(folder_path)
        csv_file_path = os.path.join(folder_path, f'worldometer_data({country_name}).csv')
        ...
        print(f"{country_name}: data pulled successfully")
    except:
        print(f"{country_name}: data pulling failed")